...
-- CreateIndex
CREATE INDEX "settlements_period_start_idx" ON "settlements"("period_start");

-- CreateIndex
CREATE INDEX "settlements_period_end_idx" ON "settlements"("period_end");
...
-- AddForeignKey
ALTER TABLE "settlement_transactions" ADD CONSTRAINT "settlement_transactions_transaction_id_fkey" FOREIGN KEY ("transaction_id") REFERENCES "transactions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
